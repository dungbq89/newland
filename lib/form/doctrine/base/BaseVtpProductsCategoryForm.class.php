...
abstract class BaseVtpProductsCategoryForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'msiisdn'       => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'long'          => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      ...
      'msiisdn'       => new sfValidatorString(array('max_length' => 255, 'required' => false)),
