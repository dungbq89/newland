                            ...
                            <div id="slider" class="flexslider view-photo">
                                <ul class="slides">
                                    ...
                                    foreach ($listPhoto as $photo) {
                                        ?>
                                        <li><img
                                                src="<?php echo VtHelper::getPathImage($photo['file_path'], sfConfig::get('app_album_images')) ?>"
                            ...
                            <div id="carousel" class="flexslider">
                                <ul class="slides thumb-photo">
                                    ...
                                    foreach ($listPhoto as $photo) {
                                        ?>
                                        <li><img
                                                src="<?php echo VtHelper::getUrlImagePathThumb(sfConfig::get('app_album_images'), $photo['file_path']) ?>"
                                                alt="<?php echo $photo['name'] ?>"
                                                title="<?php echo $photo['name'] ?>" width="100%"/></li>
                                    <?php } ?>
